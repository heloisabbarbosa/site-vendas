      ...
      <div class="row">
        <div class="content">
          <ul>
            ...
            <li id="comunicacoes" onclick="comunicacoes()">
      ...
      <div class="form-cadastro">
        <form action="">
          ...
          <div class="notice">
            ...
            <h3>Escolha como você quer receber nossas comunicações</h3>
          </div>
          <div class="checkbox">
            <input type="checkbox" name="">
            <label for="status">Saiba se alguém já comprou algum anúncio.</label>
          </div>
          <div class="checkbox">
            <input type="checkbox" name="">
            <label for="status">Ver quantas pessoas viram seu anúncio.</label>
          </div>
          <div class="checkbox">
            <input type="checkbox" name="">
            <label for="status">Informações sobre o estado da denúncia que você reportou.</label>
          </div>
          <div class="checkbox">
            <input type="checkbox" name="">
            <label for="status">Saiba quando tem novidades e funcionalidades novas.</label>
          </div>
          <div class="checkbox">
            <input type="checkbox" name="">
            <label for="status">Informações sobre a segurança da sua conta.</label>
          </div>
        </form>
      </div>
    </div>
